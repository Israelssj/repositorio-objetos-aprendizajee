...
public class ElementosCrucigramaController {
    ...
    // Obtener todos los elementos de crucigrama
    @GetMapping
    ...
    // Obtener un elemento de crucigrama por su ID
    @GetMapping("/{id}")
    ...
    // Crear un nuevo elemento de crucigrama
    @PostMapping
    ...
    // Actualizar un elemento de crucigrama existente
    @PutMapping("/{id}")
    ...
    // Eliminar un elemento de crucigrama por su ID
    @DeleteMapping("/{id}")
