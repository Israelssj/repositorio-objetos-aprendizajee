...
public class PresentacionCursoController {
    ...
    // Obtener todas las presentaciones de curso
    @GetMapping
    ...
    // Obtener una presentacion de curso por su ID
    @GetMapping("/{id}")
    ...
    // Crear una nueva presentacion de curso
    @PostMapping
    ...
    // Actualizar una presentacion de curso existente
    @PutMapping("/{id}")
    ...
    // Eliminar una presentacion de curso por su ID
    @DeleteMapping("/{id}")
