...
public class CrucigramaController {
    ...
    // Obtener un crucigrama por su ID
    @GetMapping("/{id}")
    ...
    // Actualizar un crucigrama existente
    @PutMapping("/{id}")
    ...
    // Eliminar un crucigrama por su ID
    @DeleteMapping("/{id}")
