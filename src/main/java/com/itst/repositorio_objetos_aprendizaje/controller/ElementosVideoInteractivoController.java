...
public class ElementosVideoInteractivoController {
    ...
    // Obtener todos los elementos de video interactivo
    @GetMapping
    ...
    // Obtener un elemento de video interactivo por su ID
    @GetMapping("/{id}")
    ...
    // Crear un nuevo elemento de video interactivo
    @PostMapping
    ...
    // Actualizar un elemento de video interactivo existente
    @PutMapping("/{id}")
    ...
    // Eliminar un elemento de video interactivo por su ID
    @DeleteMapping("/{id}")
