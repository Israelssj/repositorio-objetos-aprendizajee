...
public class VideoInteractivoController {
    ...
    // Obtener todos los videos interactivos
    @GetMapping
    ...
    // Obtener un video interactivo por su ID
    @GetMapping("/{id}")
    ...
    // Crear un nuevo video interactivo
    @PostMapping
    ...
    // Actualizar un video interactivo existente
    @PutMapping("/{id}")
    ...
    // Eliminar un video interactivo por su ID
    @DeleteMapping("/{id}")
