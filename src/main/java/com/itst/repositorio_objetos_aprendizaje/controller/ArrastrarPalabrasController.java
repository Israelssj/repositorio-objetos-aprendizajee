...
public class ArrastrarPalabrasController {
    ...
    // Obtener todos los arrastrar palabras
    @GetMapping
    ...
    // Obtener un arrastrar palabras por su ID
    @GetMapping("/{id}")
    ...
    // Crear un nuevo arrastrar palabras
    @PostMapping
    ...
    // Actualizar un arrastrar palabras existente
    @PutMapping("/{id}")
    ...
    // Eliminar un arrastrar palabras por su ID
    @DeleteMapping("/{id}")
