...
public class ElementosCuestionarioController {
    ...
    // Obtener todos los elementos de cuestionario
    @GetMapping
    ...
    // Obtener un elemento de cuestionario por su ID
    @GetMapping("/{id}")
    ...
    // Crear un nuevo elemento de cuestionario
    @PostMapping
    ...
    // Actualizar un elemento de cuestionario existente
    @PutMapping("/{id}")
    ...
    // Eliminar un elemento de cuestionario por su ID
    @DeleteMapping("/{id}")
