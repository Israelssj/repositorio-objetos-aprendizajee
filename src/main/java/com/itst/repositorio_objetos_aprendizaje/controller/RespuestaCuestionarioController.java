...
public class RespuestaCuestionarioController {
    ...
    // Obtener todas las respuestas de cuestionario
    @GetMapping
    ...
    // Obtener una respuesta de cuestionario por su ID
    @GetMapping("/{id}")
    ...
    // Actualizar una respuesta de cuestionario existente
    @PutMapping("/{id}")
    ...
    // Eliminar una respuesta de cuestionario por su ID
    @DeleteMapping("/{id}")
